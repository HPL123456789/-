                                        ...
                                        myChart.setOption({
												...
												toolbox:{//工具栏
													show:true
														...
														saveAsImage:{//保存为图片
															type:'png'//图片类型 默认png
																,name:'9月18-24的pv量' //保存的文件名称，默认使用 title.text 作为名称
														}
													}
												},
                                                series : [ {
                                            ...
                                            ,success:function (data) {
                                                ...
                                                myChart.setOption({
                                                    ...
                                                    ,series:[
                                                        {
                                                            type:'bar' //图表类型
                                                            ,name:'PV量'// 系列名称，用于tooltip的显示，legend 的图例筛选
                                                            ,data:data.data
                                                        }
									...
									$.ajax({
										...
										,success:function (data) {
											...
											myChart3.setOption({
												...
												{
													name : '北京',
													value : data.at(0) === 0 ? null : data.at(0)
												},
												{
													name : '天津',
													value : data.at(1) === 0 ? null : data.at(1)
												},
												{
													name : '上海',
													value : data.at(2) === 0 ? null : data.at(2)
												},
												{
													name : '重庆',
													value : data.at(3) === 0 ? null : data.at(3)
												},
												{
													name : '河北',
													value : data.at(4) === 0 ? null : data.at(4)
												},
												{
													name : '河南',
													value : data.at(5) === 0 ? null : data.at(5)
												},
												{
													name : '云南',
													value : data.at(6) === 0 ? null : data.at(6)
												},
												{
													name : '辽宁',
													value : data.at(7) === 0 ? null : data.at(7)
												},
												{
													name : '黑龙江',
													value : data.at(8) === 0 ? null : data.at(8)
												},
												{
													name : '湖南',
													value : data.at(9) === 0 ? null : data.at(9)
												},
												{
													name : '安徽',
													value : data.at(10) === 0 ? null : data.at(10)
												},
												{
													name : '山东',
													value : data.at(11) === 0 ? null : data.at(11)
												},
												{
													name : '新疆',
													value : data.at(12) === 0 ? null : data.at(12)
												},
												{
													name : '江苏',
													value : data.at(13) === 0 ? null : data.at(13)
												},
												{
													name : '浙江',
													value : data.at(14) === 0 ? null : data.at(14)
												},
												{
													name : '江西',
													value : data.at(15) === 0 ? null : data.at(15)
												},
												{
													name : '湖北',
													value : data.at(16) === 0 ? null : data.at(16)
												},
												{
													name : '广西',
													value : data.at(17) === 0 ? null : data.at(17)
												},
												{
													name : '甘肃',
													value : data.at(18) === 0 ? null : data.at(18)
												},
												{
													name : '山西',
													value : data.at(19) === 0 ? null : data.at(19)
												},
												{
													name : '内蒙古',
													value : data.at(20) === 0 ? null : data.at(20)
												},
												{
													name : '陕西',
													value : data.at(21) === 0 ? null : data.at(21)
												},
												{
													name : '吉林',
													value : data.at(22) === 0 ? null : data.at(22)
												},
												{
													name : '福建',
													value : data.at(23) === 0 ? null : data.at(23)
												},
												{
													name : '贵州',
													value : data.at(24) === 0 ? null : data.at(24)
												},
												{
													name : '广东',
													value : data.at(25) === 0 ? null : data.at(25)
												},
												{
													name : '青海',
													value : data.at(26) === 0 ? null : data.at(26)
												},
												{
													name : '西藏',
													value : data.at(27) === 0 ? null : data.at(27)
												},
												{
													name : '四川',
													value : data.at(28) === 0 ? null : data.at(28)
												},
												{
													name : '宁夏',
													value : data.at(29) === 0 ? null : data.at(29)
												},
												{
													name : '海南',
													value : data.at(30) === 0 ? null : data.at(30)
												},
												{
													name : '台湾',
													value : data.at(31) === 0 ? null : data.at(31)
												},
												{
													name : '香港',
													value : data.at(32) === 0 ? null : data.at(32)
												},
												{
													name : '澳门',
													value : data.at(33) === 0 ? null : data.at(33)
												}
											]
													}
